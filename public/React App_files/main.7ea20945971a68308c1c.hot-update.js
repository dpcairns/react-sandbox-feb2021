...
class SearchPage extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  render() {
    this.state.quotes.sort((a, b) => // we use brackets here because we don't know ahead of time what the user wants us to sort by. That will change every time the iuser selectss from the dropdown. When state changes, we will sort the data again. We use brackets to show that the property we're sorting by is dynamic
    a[this.state.sortBy].localeCompare(b[this.state.sortBy]));
    return /*#__PURE__*/Object(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__["jsxDEV"])(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__["Fragment"], {
      children: ["Sort By", /*#__PURE__*/Object(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_4__["jsxDEV"])("select", {
...
//# sourceMappingURL=main.7ea20945971a68308c1c.hot-update.js.map