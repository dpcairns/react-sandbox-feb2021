...
class SearchPage extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  render() {
    this.state.quotes.sort((a, b) => // we use brackets here because we don't know ahead of time what the user wants us to sort by. That will change every time the iuser selects from the dropdown. When state changes, we will sort the data again. We use brackets to show that the property we're sorting by is dynamic
...
//# sourceMappingURL=main.79bfb62f0a63a66e7b6d.hot-update.js.map